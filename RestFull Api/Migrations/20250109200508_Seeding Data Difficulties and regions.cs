    ...
    public partial class SeedingDataDifficultiesandregions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1848d7a3-8584-4355-8142-9f9e4dc78d0c"), "easy" },
                    { new Guid("6c6c3544-549a-42a5-8210-f8742dda840a"), "Medium" },
                    { new Guid("ebea67d8-0776-45ae-97e1-720e8bbdde71"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulity",
                keyColumn: "Id",
                keyValue: new Guid("1848d7a3-8584-4355-8142-9f9e4dc78d0c"));

            migrationBuilder.DeleteData(
                table: "Difficulity",
                keyColumn: "Id",
                keyValue: new Guid("6c6c3544-549a-42a5-8210-f8742dda840a"));

            migrationBuilder.DeleteData(
                table: "Difficulity",
                keyColumn: "Id",
                keyValue: new Guid("ebea67d8-0776-45ae-97e1-720e8bbdde71"));
